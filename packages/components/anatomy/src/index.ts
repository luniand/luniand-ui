import { anatomy } from "@luniand-ui/theme-tools";

/**
 * Hey! Welcome to @luniand-ui/vue-next Anatomy
 *
 * The anatomy of all luniand components
 *
 * @see Docs     https://vue.luniand-ui.com/anatomy
 * @see Source   https://github.com/rhp-island/luniand-ui/blob/master/packages/anatomy/src/anatomy/anatomy.ts
