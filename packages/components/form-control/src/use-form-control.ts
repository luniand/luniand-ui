import {
  ...
  import { useId, useIds } from '@luniand-ui/vue-composables';
  import { ariaAttr, dataAttr, callAllHandlers } from '@luniand-ui/utils';
  import { HTMLLuniandProps, ThemingProps } from '@luniand-ui/system';
  ...
  export type LFormControlProviderContext = ComputedRef<
    Omit<ReturnType<typeof useFormControlProvider>, 'rootProps'>
  >;
  
  const [FormControlProvider, useFormControlContext] =
    createContext<LFormControlProviderContext>({
      strict: false,
  ...
  export interface LFormControlProps
