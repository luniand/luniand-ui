...
const Template: StoryFn = (args: any) => ({
  ...
  setup() {
    ...
    return { args, isOpen, useToggle, toggleOpen };
  },
  template: `
        <LButton color-scheme="blue" @click="toggleOpen">Open</LButton>
        <LDrawer v-model="isOpen">
        <LDrawerOverlay />
        <LDrawerContent>
            <div>This is the drawer content</div>
            <LButton color-scheme="blue" @click="isOpen = false" >Close</LButton>
        </LDrawerContent>
        </LDrawer>
  `,
});
...
const MuchContentTemplate: StoryFn = (args: any) => ({
  components: {
    LDrawer,
    LDrawerBody,
    LDrawerFooter,
  ...
  template: `
        <LButton color-scheme="blue" @click="toggleOpen">Open</LButton>
        <LDrawer v-model="isOpen" placement="bottom" size="md">
        <LDrawerOverlay />
        <LDrawerContent>
        <LDrawerHeader> Basic Drawer Much content </LDrawerHeader>
        <LDrawerBody>
...
export const DrawerWithMuchContent = MuchContentTemplate.bind({});
