...
export const ring: Config = {
  ...
  ringColor: t.colors("--luniand-ring-color"),
  ringOffset: t.prop("--luniand-ring-offset-width"),
  ringOffsetColor: t.colors("--luniand-ring-offset-color"),
  ringInset: t.prop("--luniand-ring-inset"),
};
