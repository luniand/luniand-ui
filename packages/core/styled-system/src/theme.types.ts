 ...
 * Augmentation feature and is an alternative to running `npx @luniand-ui/cli
 * tokens`
 *
 * @example
 * ```ts
 * import { BaseThemeTypings } from "@luniand-ui/styled-system";
 *
 * type DefaultSizes = 'small' | 'medium' | 'large';
 *
 * declare module "@luniand-ui/styled-system" {
