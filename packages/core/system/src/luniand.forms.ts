...
export type LuniandFactoryElements = "input" | "select" | "textarea";

interface LuniandFactoryElementHandlers {
  onChange?: Function[];
  onInput?: Function[];
}
...
const events = new Map<
  ...
  LuniandFactoryElementHandlers
>();

export function useFormElement(element: LuniandFactoryElements, props: any) {
