...
export interface LuniandProps extends SystemProps, StyleResolverProps {
  /**
  ...
  /**
   * Internal prop used to label Luniand factory component tags
   */
  label?: string;
  /**
...
export type HTMLLuniandProps<T extends As> = Omit<
  PropsOf<T>,
  T extends "svg"
